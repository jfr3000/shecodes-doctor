...
function getFileContent(vimrcFile) {
    ...
    try {
        ...
        var message = cross + " It seems you don't yet have a .vimrc file. Please create one and put the following lines in it, then rerun this program to make sure everything is correct:";
...
function getPreface(messages) {
    if (messages.length !== 0) {
        ...
        return checkmark+ " Congratulations! Your .vimrc file is in ship shape!";
    }    
}
