...
function getSSHSettings(){
    ...
    try {
        ...
        var message = cross + " It seems you don't yet have SSH keys. Please create them (instructions here, for example: https://help.github.com/articles/generating-ssh-keys/) and make sure the settings are as following. Then rerun this program to make sure everything is correct:";
...
function getPreface(messages) {
    if (messages.length === 0) {
        ...
        return checkmark +" Everything is fine! Happy SSH'ing!";
    } else {
